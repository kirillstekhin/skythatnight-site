...
# 18.08.2026: img переведены на props-сцены (кольца/пинетки/реквизит повода, рамы = референсы
# Prodigi, tools/props_batch_2026-08-18.py); старые occ-*.jpg остаются для фида/истории.
...
OCC = {
    "met": dict(
        ...
        img="props-met.jpg", metatitle="Star Map for the Night You Met",
    ...
    "proposal": dict(
        ...
        img="props-proposal.jpg", metatitle="Star Map for a Proposal — She Said Yes",
    ...
    "wedding": dict(
        ...
        img="props-wedding.jpg", metatitle="Wedding Star Map — The Sky of Your Wedding Night",
    ...
    "born": dict(
        ...
        img="props-born.jpg", metatitle="New Baby Star Map — The Night They Were Born",
    ...
    "anniversary": dict(
        ...
        img="props-anniversary.jpg", metatitle="Anniversary Star Map — The Sky of Your Date",
    ...
    "birthday": dict(
        ...
        img="props-birthday.jpg", metatitle="Birthday Star Map — The Sky the Day You Were Born",
    ...
    "new-home": dict(
        ...
        img="props-new-home.jpg", metatitle="New Home Star Map — The Sky Above Your New Address",
    ...
    "retirement": dict(
        ...
        img="props-retirement.jpg", metatitle="Retirement Star Map — The Sky of a Life's Work",
    ...
    "memorial": dict(
        ...
        img="props-memorial.jpg", metatitle="Memorial Star Map — A Keepsake to Remember Them By",
